...
# Homo Deus
  ...
  - The state hopes to manipulate the biochemical pusuit of happiness, separating "bad" manipulations from "good" ones. The prinicple is clear: biochemical manipulations that strengthen pilitical stability, social order and economic growth are allowed and even encouraged. Manipulations that threaten stability and growth are bad.
  ...
  - We may well think of the new human agenda as consistenting really of only one project (with any branches): attaining divinity.
  - Thoughout history most gods were belived to enjoy not omnipotence but rather specific super-abilties such as the ability to design and create living beingsl to transform thier own bodies; to control the enviroment and the weather; to read minds and to comminicate at a distance; to travel at very high speeds; and of course to escape death and live indefinitely.  Humans are in the business of acquiring all these abilities, and then some.