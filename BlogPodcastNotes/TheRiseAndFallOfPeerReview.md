...
- Peer review was a huge, expensive intervention.  Huge interventions should have huge effects.
  if peer review improved science, that should be pretty obvious, and we should be pretty upset and embarrassed if it didn’t.
